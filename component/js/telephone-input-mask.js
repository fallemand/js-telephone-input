...
function telephoneInputMask(field, parameters) {
    ...
    function getMask(data) {
        ...
        return (startsWithZero(data)) ? metadata.masks.withZero[codeAreaDigits].split('') : metadata.masks[codeAreaDigits].split('');
    }
    ...
    function getMaxCharacters() {
        ...
        return (startsWithZero(value)) ? metadata.validations.maxCharacters + 1 : metadata.validations.maxCharacters;
    }
